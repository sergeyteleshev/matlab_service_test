arguments
global factorPlanFileName nFeatures effectsPlanFileName;
...
xlswrite(effectsPlanFileName, e_headers, 1, "A2:A8"); 
xlswrite(effectsPlanFileName, factor_headers, 1, "B1:H1");
xlswrite(effectsPlanFileName, e, 1, "B2:H8");
